...
class HomeView extends StatelessWidget {
  ...
  final List<Map<String, String>> data = [
    ...
    {
      "name": "Shaihan Sulleman",
      "phone": "434-5712",
      "email": "shai.nam@aol.edu",
      "country": "Brazil",
      "region": "Huáběi"
    },
    {
    ...
    {
      "name": "Yasir Mohammed",
      "phone": "1-768-898-0868",
      "email": "yasir@google.edu",
      "country": "Chile",
            ...
            ListView.separated(
                ...
                itemBuilder: (context, index) {
                  return ListTile(
                    ...
                    subtitle: const Text('+233 24 59 36 757'),
